 ...
 */
class WalkerHandlerBase: public AFQMCInfo
{

  public:

  /// constructor
  WalkerHandlerBase(AFQMCInfo& info, RandomGenerator_t* r, std::string type="collinear"): 
            AFQMCInfo(info),rng(r),name("")
  ...
  virtual ComplexType* getSMN(int n)=0;
  ...
  virtual ComplexType* getPM(int n)=0;
  virtual void incrementPM(int n)=0;
  virtual void decrementPM(int n)=0;
  virtual bool isPMBufferFull(int n)=0;
  ...
  virtual void copy_slater_matrix_to_historic_slater_matrix(int n)=0;
  virtual ComplexType getCosineFactor(int n)=0;
  virtual void setCosineFactor(int n, ComplexType cfac)=0;
  virtual ComplexType getWeightFactor(int n)=0;
  virtual void setWeightFactor(int n, ComplexType cfac)=0;
  virtual int getNBackProp()=0;
