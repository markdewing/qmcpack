...
#endif
#endif
  spline->coefs = maybe_align_alloc(sizeof(float)*N, 16, "einspline::create_UBspline_1d_s");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(sizeof(float)*Nx*Ny, 16, "einspline::create_UBspline_2d_s");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(sizeof(float)*spline->coefs_size, 16, "einspline::create_UBspline_3d_s");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(2*sizeof(float)*N, 16, "einspline::create_UBspline_1d_c");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(2*sizeof(float)*Nx*Ny, 16, "einspline::create_UBspline_2d_c");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(2*sizeof(float)*Nx*Ny*Nz, 16, "einspline::create_UBspline_3d_c");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(sizeof(double)*N, 16, "einspline::create_UBspline_1d_d");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(sizeof(double)*Nx*Ny, 16, "einspline::create_UBspline_2d_d");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(sizeof(double)*spline->coefs_size, 16, "einspline::create_UBspline_3d_d");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(2*sizeof(double)*N, 16, "einspline::create_UBspline_1d_z");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(2*sizeof(double)*Nx*Ny, 16, "einspline::create_UBspline_2d_z");
...
#endif
#endif
  spline->coefs = maybe_align_alloc(2*sizeof(double)*Nx*Ny*Nz, 16, "einspline::create_UBspline_3d_z");
